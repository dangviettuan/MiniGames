    ...
    <div className="app">
      <style>{`
        ...
        *{box-sizing:border-box;-webkit-tap-highlight-color:transparent}
        ...
        .board{display:grid;grid-template-columns:repeat(9,minmax(0,1fr));border:2px solid var(--line);border-radius:14px;overflow:hidden;background:var(--board)}
        ...
        .dot{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:13px;height:13px;border-radius:999px;background:rgba(120,53,15,.55);border:2px solid rgba(255,255,255,.7)}
        .piece{position:absolute;inset:10%;display:grid;place-items:center;border-radius:999px;background:#fffdf8;border:3px solid #1f2937;box-shadow:0 5px 10px rgba(31,41,55,.16);font-size:clamp(20px,2.35vw,30px);font-weight:800;user-select:none}
